...
public class ModBlocks
{
    ...
    public static final Block glassLamp = new GlassLamp(Material.glass).setLightLevel(1.0F).setBlockName("glassLamp").setHardness(0.3F).setResistance(0.3F).setCreativeTab(CreativeTabJC.JC_TAB).setBlockTextureName("glassLamp");
